      ...
      <div id="wd-assignments-editor">
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              <select>
              <option value="VAL1" id="wd-group">ASSIGNMENTS</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select>
              <option value="VAL1" id="wd-display-grade-as">Percentage</option>
              </select>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <select>
              <option value="VAL1" id="wd-submission-type">Online</option>
              </select>
            </td>
          </tr>
        </table>
