  ...
  return (
    <div id="wd-working-with-objects">
      ...
      <div className="form-check">
        <input
            type="checkbox"
            className="form-check-input" id="wd-assignment-completed" checked={assignment.completed}
        ...
        href={`${ASSIGNMENT_API_URL}/completed/${String(assignment.completed)}`}
        > Update Assignment Completion </a>
        <hr />
